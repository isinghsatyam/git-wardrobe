...
`~/.config/git-wardrobe/config.toml` is the single source of truth, and it's yours to edit. Swap an account's key, change its email or directory, flip signing mode — then:
